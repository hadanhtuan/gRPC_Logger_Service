...
// ApplyDatabase convert bson to object
func (m *DBInstance) ApplyDatabase(database *mongo.Database) *DBInstance {
	m.db = database
...
func (m *DBInstance) convertToObject(b bson.M) (interface{}, error) {
	obj := m.newObject()
...
func (m *DBInstance) convertToBson(ent interface{}) (bson.M, error) {
	if ent == nil {
		return bson.M{}, nil
	}
...
func (m *DBInstance) newObject() interface{} {
...
func (m *DBInstance) newList(limit int) interface{} {
	t := reflect.TypeOf(m.TemplateObject)
	return reflect.MakeSlice(reflect.SliceOf(t), 0, limit).Interface()
}

func (m *DBInstance) interfaceSlice(slice interface{}) ([]interface{}, error) {
...
func (m *DBInstance) parseSingleResult(result *mongo.SingleResult, action string) *common.APIResponse {
	// parse result
	obj := m.newObject()
...
func (m *DBInstance) Create(entity interface{}) *common.APIResponse {
...
func (m *DBInstance) CreateMany(entityList interface{}) *common.APIResponse {
...
func (m *DBInstance) Query(query interface{}, offset int64, limit int64, sortFields *bson.M) *common.APIResponse {
	// check col
	if m.col == nil {
		return &common.APIResponse{
			Status:  common.APIStatus.Error,
	...
	if err != nil || result.Err() != nil {
		errMsg := "Not found any matched " + m.ColName + "."
		if err != nil {
			errMsg += " Error detail: " + err.Error() + "."
		}
...
// QueryAll Get all object in DB
func (m *DBInstance) QueryAll() *common.APIResponse {
	// check col
	if m.col == nil {
		return &common.APIResponse{
			Status:    common.APIStatus.Error,
	...
	if err != nil {
		return &common.APIResponse{
			Status:    common.APIStatus.NotFound,
			Message:   "Not found any matched " + m.ColName + ". Error detail: " + err.Error(),
			ErrorCode: "NOT_FOUND",
		}
	}
...
// QueryOne ...
func (m *DBInstance) QueryOne(query interface{}) *common.APIResponse {
	// check col
	if m.col == nil {
		return &common.APIResponse{
			Status:  common.APIStatus.Error,
...
func (m *DBInstance) UpdateMany(query interface{}, updater interface{}) *common.APIResponse {
	// check col
	if m.col == nil {
		return &common.APIResponse{
			Status:  common.APIStatus.Error,
...
func (m *DBInstance) UpdateOne(query interface{}, updater interface{}, opts ...*options.FindOneAndUpdateOptions) *common.APIResponse {
	// check col
	if m.col == nil {
		return &common.APIResponse{
			Status:  common.APIStatus.Error,
...
// UpdateOne Update one matched object.
func (m *DBInstance) Upsert(query interface{}, updater interface{}) *common.APIResponse {
	// check col
	if m.col == nil {
		return &common.APIResponse{
			Status:  common.APIStatus.Error,
...
func (m *DBInstance) UpdateOneWithOption(query interface{}, updater interface{}, opts ...*options.FindOneAndUpdateOptions) *common.APIResponse {
	// check col
	if m.col == nil {
		return &common.APIResponse{
			Status:  common.APIStatus.Error,
...
func (m *DBInstance) ReplaceOneWithOption(query interface{}, replacement interface{}, opts ...*options.FindOneAndReplaceOptions) *common.APIResponse {
	// check col
	if m.col == nil {
		return &common.APIResponse{
			Status:  common.APIStatus.Error,
...
func (m *DBInstance) Delete(query interface{}) *common.APIResponse {
	// check col
	if m.col == nil {
		return &common.APIResponse{
			Status:  common.APIStatus.Error,
...
func (m *DBInstance) Count(query interface{}) *common.APIResponse {
	// check col
	if m.col == nil {
		return &common.APIResponse{
			Status:  common.APIStatus.Error,
...
func (m *DBInstance) IncreOne(query interface{}, fieldName string, value int) *common.APIResponse {
	// check col
	if m.col == nil {
		return &common.APIResponse{
			Status:  common.APIStatus.Error,
...
// CreateIndex ...
func (m *DBInstance) CreateIndex(keys bson.D, options *options.IndexOptions) error {
...
// Aggregate ...
func (m *DBInstance) Aggregate(pipeline interface{}, result interface{}) *common.APIResponse {
	// check col
	if m.col == nil {
		return &common.APIResponse{
			Status:  common.APIStatus.Error,
...
// Aggregate ...
func (m *DBInstance) Distinct(filter interface{}, field string, opt ...*options.DistinctOptions) *common.APIResponse {
	// check col
	if m.col == nil {
		return &common.APIResponse{
			Status:  common.APIStatus.Error,
...
// Get Client
func (m *DBInstance) GetClient() *mongo.Client {
	return m.db.Client()
}

// GetChangeStream func
func (m *DBInstance) GetChangeStream(dbName string, collectionName string, cb func(bson.M)) (err error) {
...
func (m *DBInstance) GetChangeStreamWithOpt(dbName string, collectionName string, opts *options.ChangeStreamOptions, cb func(bson.M)) (err error) {
...
// QueryWithOptions Get many object in DB
// Maximum result is 1000
func (m *DBInstance) QueryWithOptions(query interface{}, opt *options.FindOptions) *common.APIResponse {
	if opt == nil {
		return &common.APIResponse{
			Status:  common.APIStatus.Error,
